...
// 矩阵连接
let composedMatrix = v3.Matrix4x3.matrix4x3Multiply(rotationMatrix, translationMatrix4x3)

// 获得变换后三个点位置
let newA = v3.Matrix4x3.vector3Multiply(a, composedMatrix)
let newB = v3.Matrix4x3.vector3Multiply(b, composedMatrix)
let newC = v3.Matrix4x3.vector3Multiply(c, composedMatrix)
